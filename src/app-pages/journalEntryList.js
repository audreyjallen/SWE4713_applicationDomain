...
export const EntryList = () => {
    ...
    const columns = [
        ...
        { id: 'accountName', label: 'Account Name', minWidth: 150 },
        {
          id: 'amount',
          label: 'Amount',
          minWidth: 100,
      ...
      function createData(date, accountName, amount, status) {
        return { date, accountName, amount, status };
      }
      
      const rows = [
        createData("3/29/2023", <button className = "link-btn">Basic Assets Account</button>, "$1500", "Pending")
      ];
